  ...
  groups: [
    ...
    },
    {
      ...
      rules: [
        {
          name: 'V1',
          versionCode: { maximum: 260849 },
          matches: ['[vid="alertTitle"][text="流量安装提醒"]', '[vid="download_remind_download_btn"]'],
        },
        {
          name: 'V2',
          versionCode: { minimum: 260850 },
          matches: ['[vid="alertTitle"][text="流量安装提醒"]', '[text="直接下载并安装"]'],
        },
      ],
    },
    {
      ...
      rules: [
        ...
        },
        {
          name: 'V2-WiFi',
          versionCode: { minimum: 260850 },
          matches: ['[vid="alertTitle"][text="流量安装提醒"]', '[text="仅 WLAN 下载并安装"]'],
        },
        {
          name: 'V2-流量',
          versionCode: { minimum: 260850 },
          matches: ['[vid="alertTitle"][text="流量安装提醒"]', '[text="稍后安装"]'],
        },
      ],
    },
    {
